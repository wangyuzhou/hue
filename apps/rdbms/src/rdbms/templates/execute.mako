    ...
    <div class="container-fluid">
      <div class="nav-collapse">
        <ul class="nav">
          ...
          <li class="${is_selected(section, 'query')}"><a href="${ url('rdbms:execute_query') }">${_('Query Editor')}</a></li>
          <li class="${is_selected(section, 'my queries')}"><a href="${ url('rdbms:my_queries') }">${_('My Queries')}</a></li>
          <li class="${is_selected(section, 'saved queries')}"><a href="${ url('rdbms:list_designs') }">${_('Saved Queries')}</a></li>
          <li class="${is_selected(section, 'history')}"><a href="${ url('rdbms:list_query_history') }">${_('History')}</a></li>
        </ul>
      </div>
    </div>
  </div>
...
<div class="container-fluid">
  ...
  <div id="query" class="row-fluid">
    ...
    <div data-bind="css: {'hide': rows().length == 0}" class="row-fluid">
